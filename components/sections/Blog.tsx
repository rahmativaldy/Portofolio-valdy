...
export function Blog() {
  ...
  return (
    ...
    >
      ...
      {selectedNote && (
        <div
          className="fixed inset-0 z-50 bg-black/75 backdrop-blur-sm flex items-center justify-center p-4 sm:p-6 md:p-8 animate-fadeIn"
          role="dialog"
          aria-modal="true"
          aria-labelledby="note-modal-title"
        >
          <div className="relative w-full max-w-2xl max-h-[85vh] overflow-y-auto rounded-sm bg-white dark:bg-[#121215] border border-zinc-200 dark:border-zinc-800 shadow-2xl p-6 sm:p-8 space-y-6 select-text text-zinc-900 dark:text-zinc-100">
            {/* Modal Header Bar */}
            <div className="flex items-center justify-between gap-4 border-b border-zinc-200 dark:border-zinc-800 pb-4">
              ...
              <button
                ...
                className="p-1 rounded text-zinc-400 hover:text-zinc-950 dark:hover:text-white transition cursor-pointer"
            ...
            <div className="space-y-6">
              <h2
                id="note-modal-title"
                className="text-2xl sm:text-3xl font-bold tracking-tight text-zinc-950 dark:text-white leading-tight"
              >
                {selectedNote.title}
              </h2>
              ...
              {/* Key Takeaway Box */}
              <div className="border-l-2 border-zinc-950 dark:border-white bg-zinc-100 dark:bg-zinc-900/90 p-4 rounded-r-sm space-y-1">
            ...
            <div className="pt-4 border-t border-zinc-200 dark:border-zinc-800 flex justify-end">
              <button
                type="button"
                onClick={handleCloseNote}
                className="px-4 py-2 rounded-sm bg-zinc-950 text-white dark:bg-white dark:text-zinc-950 text-xs font-mono font-semibold uppercase tracking-wider hover:bg-zinc-800 dark:hover:bg-zinc-200 transition cursor-pointer"
              >
                Close Note
              </button>
            </div>
