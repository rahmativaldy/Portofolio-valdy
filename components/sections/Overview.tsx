...
export function Overview() {
  ...
  return (
    <div
      className="relative overflow-hidden w-full min-h-full"
      id="overview"
    >
      {/* Ambient Ballpit Background Layer — Covers Entire Overview Section */}
      <div className="absolute inset-0 pointer-events-none z-0 opacity-35 dark:opacity-25 transition-opacity duration-300">
        <Ballpit />
      </div>

      {/* Overview Content Container */}
      <div className="relative z-10 max-w-5xl xl:max-w-6xl mx-auto px-4 sm:px-6 md:px-10 py-8 sm:py-12 md:py-16 text-zinc-900 dark:text-zinc-100 space-y-12 sm:space-y-16 md:space-y-20">
        {/* 1. HERO / IDENTITY */}
