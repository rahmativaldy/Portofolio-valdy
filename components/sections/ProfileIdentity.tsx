...
export function ProfileIdentity({
  ...
  return (
    <div className="flex flex-col items-center text-center px-2 select-none">
      {/* Avatar Container (Responsive circular portrait ~185px on desktop) */}
      <div className="relative shrink-0 mb-2.5 group">
        <div className="relative w-36 h-36 sm:w-40 sm:h-40 md:w-[185px] md:h-[185px] aspect-square rounded-full overflow-hidden border-2 border-zinc-300 dark:border-zinc-700 bg-zinc-100 dark:bg-zinc-800 shadow-xs mx-auto transition-transform duration-200 ease-out group-hover:scale-[1.02]">
      ...
      {!isCollapsed && (
        <div className="space-y-1 w-full flex flex-col items-center">
          {/* Name */}
          <div>
            <h2 className="text-xl font-bold tracking-tight text-zinc-950 dark:text-white leading-snug font-sans">
              Rahmat Ivaldy
            </h2>
          </div>
          ...
          {/* Role */}
          <div>
            <p className="text-xs text-zinc-500 dark:text-zinc-400 font-sans leading-normal max-w-[240px] text-center">
              {t.sidebar.role}
            </p>
          </div>
