...
export const en: TranslationDictionary = {
  navigation: {
    ...
    guestbookDesc: 'Leave a note and say hello',
  ...
  guestbook: {
    badge: '06 / GUESTBOOK',
    title: 'Guestbook',
    subtitle: 'Public workspace notes and visitor greetings',
    statusCount: 'messages',
    heroHeading: 'Leave a note.',
    heroDescription:
      'A small place for visitors to share their thoughts, feedback, or simply say hello.',
    auth: {
      signInTitle: 'Sign in with Account (Optional)',
      optionalAuthHint: 'Want to display your profile avatar? Sign in with:',
    ...
    form: {
      ...
      errors: {
        ...
        generic: 'Unable to post message. Please try again.',
      },
    },
    list: {
      title: 'Messages',
      ...
      emptySubtitle: 'Be the first to leave a note.',
    ...
    reply: {
      replyBtn: 'Reply',
      cancelBtn: 'Cancel',
      submitBtn: 'Send Reply',
      submittingBtn: 'Sending...',
      placeholder: 'Write a reply to this message...',
      authorBadge: 'Workspace Owner',
      authorName: 'Rahmat Ivaldy',
      deleteReplyBtn: 'Delete Reply',
      pinLabel: 'Admin PIN (Optional if not set)',
      pinPlaceholder: 'PIN (Default: 1234 or leave blank)',
      successToast: '✓ Reply posted successfully',
      errors: {
        tooShort: 'Reply must be at least 2 characters.',
        invalidPin: 'Invalid Admin PIN.',
        generic: 'Unable to post reply. Please try again.',
      },
    },
    footerText: 'Rahmat Workspace · Guestbook',
    backToOverviewCta: 'Back to Overview',
    readNotesCta: 'Read Notes',
    getInTouchCta: 'Get in Touch',
  },
